...
def run(state: dict) -> dict:
    ...
    print(f"🗞️  News Agent: Analyzing recent news...")
    ...
    for name in all_names:
        query = f"{name} latest news funding product launch 2024 2025"
        ...
        prompt = f"""Analyze recent news coverage for {name}.

Search Results:
{context}

Summarize in 2-3 sentences: key recent developments, announcements, funding rounds, or strategic moves.

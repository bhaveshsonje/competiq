...
def run(state: dict) -> dict:
    ...
    print(f"📊  Market Agent: Analyzing market position...")
    ...
    for name in all_names:
        query = f"{name} market share revenue growth valuation funding investors 2024 2025"
        ...
        prompt = f"""Analyze the market position of {name}.

Search Results:
{context}

Summarize in 2-3 sentences: market share estimates, revenue figures, funding raised, key investors,
target market segment, and growth trajectory."""
